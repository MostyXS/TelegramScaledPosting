...
import { addAllowedUsers, getAllowedUsers, getOwnerId, removeAllowedUsers, } from '../configs/owner.js';
export const ownerComposer = new Composer();
var Commands;
(function (Commands) {
    Commands["ListAllowedUsers"] = "owner_list_allowed_users";
    Commands["AddAllowedUser"] = "owner_add_allowed_user";
    Commands["RemoveAllowedUser"] = "owner_rm_allowed_user";
})(Commands || (Commands = {}));
export const OwnerCD = [
    {
